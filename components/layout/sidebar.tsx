...
import { Home, Users, Calendar, DollarSign, LogOut, Menu, List, Info, Accessibility, IdCard, CircleQuestionMark } from "lucide-react";
...
const navItems = [
  ...
  { name: "About", icon: Info, href: "/dashboard/about" },
  { name: "FAQs", icon: CircleQuestionMark, href: "/dashboard/faq" },
  { name: "Admins", icon: IdCard, href: "/dashboard/admins" },
];
